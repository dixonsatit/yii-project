                    ...
                    'items' => array(
                        ...
                        array(
                            ...
                            'items' => array(
                                ...
                                array('url' => array('/user/profile/changepassword'), 'icon' => 'key', 'label' => Yii::app()->getModule('user')->t("Change password"), 'visible' => !Yii::app()->user->isGuest),
                                BSHtml::menuDivider(),
                                array('url' => array('/user/admin/admin'), 'icon' => 'user', 'label' => Yii::app()->getModule('user')->t("Manage Users"), 'visible' => Yii::app()->user->isAdmin()),
                                BSHtml::menuDivider(),
                                array('url' => Yii::app()->getModule('user')->logoutUrl, 'icon' => 'unlock', 'label' => Yii::app()->getModule('user')->t("Logout") . ' (' . Yii::app()->user->name . ')', 'visible' => !Yii::app()->user->isGuest),
                            )
                        ),
                    ),
                    'htmlOptions' => array(
