...
?>
<div id="QPdfJs_viewer" dir="<?php echo $options['direction']; ?>" style="height: <?php echo $options['width']; ?>;">
...
?>
            ...
            $('#fullscreenMode').click(function() {
                ...
                $('#QPdfJs_viewer').toggleClass('qpdf-fullscreen');
            });
        });
    </script>
</head>
                ...
                <div id="toolbarContainer">
                    <div id="toolbarViewer">
                        ...
                        <div id="toolbarViewerRight">
                            ...
                            <button id="fullscreenMode" class="toolbarButton presentationMode" title="แสดงเต็มจอ" tabindex="16">
